...
const HeroSection = () => {
  ...
  const handleButtonClick = (e) => {
    ...
    circle.className = 'absolute rounded-full bg-white/30 transform scale-0 animate-ripple';
    ...
    <section className="relative p-3 bg-gray-900 text-white">
      ...
      {backgroundImages.map((image, index) => (
        <div
          ...
          style={{ backgroundImage: `url('${image}')`, filter: 'brightness(0.4)' }}
        />
      ))}
      ...
      <div className="relative z-10 flex items-center justify-center h-full px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-left md:text-center space-y-6">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight animate-fade-in-down">
            Trading Simplified For Everyone
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl font-light max-w-3xl mx-auto animate-fade-in-up">
            Access professional trading tools, real-time market data, and expert insights to make informed decisions and maximize your profits.
          </p>
          <button
