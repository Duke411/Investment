      ...
      <main className="p-6">
        ...
        <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-lg border-2">
          ...
          <p className="text-lg text-gray-700 mb-6">
            We provide flexible loan options to help you achieve your financial
            goals. Please carefully read the terms and conditions below:
          </p>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-3">
            ...
            <li>
              Required Documentation: Proof of income, Government ID, Proof of
              address
            </li>
          ...
          <p className="mt-6 text-lg text-gray-700">
            By applying for a loan, you agree to the above terms. If you have
